...
[ -n "$OAUTH_PRIVATE_KEY" ] && echo "OAUTH_PRIVATE_KEY=$OAUTH_PRIVATE_KEY" >> .env
[ -n "$OAUTH_PUBLIC_KEY" ] && echo "OAUTH_PUBLIC_KEY=$OAUTH_PUBLIC_KEY" >> .env
[ -n "$OAUTH_ENCRYPTION_KEY" ] && echo "OAUTH_ENCRYPTION_KEY=$OAUTH_ENCRYPTION_KEY" >> .env
