...
[ -n "$AUTH0_DOMAIN" ] && echo "AUTH0_DOMAIN=$AUTH0_DOMAIN" >> .env
[ -n "$AUTH0_AUDIENCE" ] && echo "AUTH0_AUDIENCE=$AUTH0_AUDIENCE" >> .env
[ -n "$MCP_ALLOWED_EMAILS" ] && echo "MCP_ALLOWED_EMAILS=$MCP_ALLOWED_EMAILS" >> .env
